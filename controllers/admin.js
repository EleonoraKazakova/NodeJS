...
exports.getAddProduct = (req, res, next) => {
    /*if (!req.session.isLoggedIn) {
        console.log('getAddProduct: ', req.session.isLoggedIn)
...
exports.getEditProduct = (req, res, next) => {
    ...
    Product.findById(prodId)
        .then(product => {
            // to test error: throw new Error('Dummy')
            if(!product) {
                return res.redirect('/')
            }
        res.render('admin/edit-product', {
...
exports.getProducts = (req, res, next) => {
    Product.find({userId: req.user._id})
        ...
        .then((products) => {
            console.log('products_userid: ', products)
...
exports.deleteProduct = (req, res, next) => {
    ...
    Product.findById(prodId)
            ...
            .then(result => {
                ...
                res.status(200).json({message: 'Product was delete successfully!'})
            })
            .catch(err => {
                console.error('Error delet product: ', err)
